...
category = Category.new(name: 'Konzerte')
file = URI.open('https://cdn.londonandpartners.com/visit/london-organisations/alexandra-palace/92923-640x360-alexandra-palace-gig-640.jpg')
category.photo.attach(io: file, filename: 'Konzerte.jpg', content_type: 'image/jpg')
category.save

category = Category.new(name: 'Filme')
file = URI.open('https://markmeets.com/wp-content/uploads/2013/10/Movie-Releases.jpg')
category.photo.attach(io: file, filename: 'Filme.jpg', content_type: 'image/jpg')
category.save

category = Category.new(name: 'Bücher')
file = URI.open('https://upload.wikimedia.org/wikipedia/commons/5/5a/Books_HD_%288314929977%29.jpg')
category.photo.attach(io: file, filename: 'Bücher.jpg', content_type: 'image/jpg')
category.save

category = Category.new(name: 'Museen')
file = URI.open('https://www.mvv-muenchen.de/fileadmin/_processed_/1/6/csm_museum_16_669_5a248290a4.jpg')
category.photo.attach(io: file, filename: 'Museen.jpg', content_type: 'image/jpg')
category.save

category = Category.new(name: 'TV-Shows')
file = URI.open('https://www.otto.de/updated/app/uploads/2020/02/xtv-aufloesung-1-560x315.jpg.pagespeed.ic.uZUoVhkYee.jpg')
category.photo.attach(io: file, filename: 'Shows.jpg', content_type: 'image/jpg')
category.save

category = Category.new(name: 'Spiele')
file = URI.open('https://i.cbc.ca/1.2716999.1406221490!/fileImage/httpImage/image.jpg_gen/derivatives/16x9_780/135000779-board-games.jpg')
category.photo.attach(io: file, filename: 'Spiele.jpg', content_type: 'image/jpg')
category.save
